...
import { isAuthenticated, getWatchlist, removeFromWatchlist } from "@/lib/storage";
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                    ...
                    <span className="text-xs text-muted-foreground hidden sm:inline">{d.vehicleType} &middot; {d.color}</span>
                  </div>
