    ...
    <AnimatePresence>
      ...
      >
          ...
          <div className="flex items-center justify-between">
            <div className="min-w-0">
              ...
              <p className="text-xs text-muted-foreground">
                {insights.vehicleType} · {insights.color}
              </p>
            </div>
        ...
        <div className="p-4 space-y-4">
          ...
          {insights.lastSeen && (
            <p className="text-xs text-muted-foreground">
              Last seen: {format(new Date(insights.lastSeen), "MMM dd, yyyy HH:mm")} at{" "}
              {insights.lastLocation}
            </p>
          )}
                ...
                <div
                  ...
                  className={`rounded-lg px-3 py-2 text-xs cursor-pointer transition-colors ${
                    selectedSession?.id === s.id
                      ? "bg-gold-muted border border-primary/20"
