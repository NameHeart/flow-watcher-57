        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="flex items-center justify-center w-36 sm:w-52 h-12 sm:h-16 rounded-xl gradient-gold-subtle border-2 border-primary/20">
            <div className="text-center">
              <span className="font-display text-[10px] sm:text-xs font-semibold text-gold-dark block">
                PARKING LOT
              </span>
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <div className="flex flex-col items-center cursor-default">
          ...
          <div
            className={`text-primary ${direction === "down" ? "animate-flow-down" : "animate-flow-up"}`}
          >
            {direction === "down" ? "↓" : "↑"}
          </div>
